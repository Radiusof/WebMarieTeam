        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p>Envie de renseignements supplémentaires ? Une question sur une réservation ? Ou juste nous envoyer un joli mot ? Remplissez le formulaire ci-dessous et nous reviendrons au plus vite vers vous !</p>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">info@marieteam.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">Port du Corniguel, 98 Av. du Corniguel, 29000 Quimper</p>
                            </div>
                        </div>
                    </div>
                </div>
